...
#include "graph_partition_utils.cuh"
                                      ...
                                      bool multi_gpu)
{
  ...
  size_t tmp_m{};
  size_t tmp_k{};
  auto mm_ret = cugraph::utilities::mm_properties<size_t>(file, 1, &mc, &tmp_m, &tmp_k, &nnz);
  ...
  mm_ret = cugraph::utilities::mm_to_coo<vertex_t, weight_t>(
